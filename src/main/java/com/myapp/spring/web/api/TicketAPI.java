...
public class TicketAPI {
	...
	return new ResponseEntity<List<Ticket>>(repository.findAll(),HttpStatus.OK);
	}
	...
	return new ResponseEntity<Ticket>(repository.save(ticket),HttpStatus.CREATED);
	}
	...
	return new ResponseEntity<Ticket>(repository.findById(id).get(),HttpStatus.OK);
	}
	...
	return new ResponseEntity<Ticket>(repository.save(existingProduct),HttpStatus.CREATED);
	}
